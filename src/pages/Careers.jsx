      ...
      <section className="py-24 bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950">
        <div className="container mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-cyan-600 hover:bg-cyan-700 text-white font-semibold px-8 py-4 rounded-lg text-lg">
              View Open Positions
              <ArrowRight className="ml-2" size={20} />
            </Button>
            <Button size="lg" variant="outline" className="border-cyan-600 text-cyan-400 hover:bg-cyan-600 hover:text-white px-8 py-4 rounded-lg text-lg">
      ...
      <footer className="bg-slate-950 py-16 border-t border-slate-800">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-4">Careers</h3>
              <ul className="space-y-2">
                {['Open Positions', 'Company Culture', 'Benefits', 'Internships', 'Remote Work'].map((item) => (
                  <li key={item}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['About Us', 'Leadership', 'News', 'Partners', 'Contact'].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">{item}</a>
                  </li>
                ))}
