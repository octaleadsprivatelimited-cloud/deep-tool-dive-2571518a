              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input 
                      type="text" 
                      placeholder="John" 
                      className="bg-slate-800 border-slate-700 text-white placeholder-slate-400 focus:border-cyan-600"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    className="bg-slate-800 border-slate-700 text-white placeholder-slate-400 focus:border-cyan-600 min-h-[120px]"
                  />
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Emergency Hotline', 'General Inquiries', 'Technical Support', 'Sales', 'Partnerships'].map((item) => (
                  <li key={item}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['About Us', 'Careers', 'News', 'Partners', 'Offices'].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors">{item}</a>
                  </li>
                ))}
